= Modern Object Pascal Compiler — Clean Pascal
:doctype: article
:toc: left
:toclevels: 3
:sectnums:
...
[source,shell]
----
cleanpascal --project project.xml --config debug --output bin/hello
----
...
[source,shell]
----
cleanpascal --source Hello.pas --output bin/hello --target linux-x86_64
----
